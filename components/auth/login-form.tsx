...
const LogInForm = () => {
  ...
  // Use the useAuth hook correctly inside the component
  ...
  const onSubmit = (data: { email: string; password: string }) => {
    startTransition(async () => {
      try {
        await signIn(data.email, data.password); // Correctly call signIn with email and password
        toast.success("Login Successful");
        router.replace("/dashboard"); // Use router.replace for client-side navigation
        reset();
      } catch (error) {
